  ...
  async function conectar(event: ChangeEvent<HTMLFormElement>){
    ...
    if(confirmarSenha === userCadastrar.senha && userCadastrar.senha.length >= 8){
      try {
        ...
        toast.error('Falha ao cadastrar o usuário. Por favor verifique os campos!!!', {
          position: 'top-right',
          autoClose: 2000,
          hideProgressBar: false,
          closeOnClick: true,
  ...
  return (
    <>
      ...
      <Grid item xs={6} style={{
        ...
        backgroundRepeat: 'no-repeat', width: '90vh', minHeight: '100vh', backgroundSize: 'cover', backgroundPosition: 'center'
    }}>
    </Grid>
